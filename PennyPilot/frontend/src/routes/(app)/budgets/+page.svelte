...
<svelte:head><title>Budgets · PennyPilot</title></svelte:head>

<div class="space-y-6">
  <PageHeader title="Budgets" description="Track spending across all your budgets.">
    {#snippet actions()}
      <Button href="/budgets/new"><Plus class="h-4 w-4" /> New budget</Button>
    {/snippet}
  </PageHeader>
  ...
  {:else if q.data}
    <BudgetList budgets={q.data.items} filtered={hasFilters} />
